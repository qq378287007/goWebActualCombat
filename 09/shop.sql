...
BEGIN;
INSERT INTO `auth`
VALUES (1, '系统管理员', 'get', 3, '3', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (2, '组织部门', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (3, '模块管理', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (4, 'Banner管理', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (5, '商品管理', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (6, '订单管理', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (7, '设置管理', '', 3, '', 0, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (
    8,
    '管理员列表',
...
INSERT INTO `auth`
VALUES (10, '', '部门列表', 2, '/role', 2, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (
    11,
    '',
...
INSERT INTO `auth`
VALUES (13, '', '权限列表', 2, '/auth', 3, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (
    14,
    '',
...
INSERT INTO `auth`
VALUES (16, '', '商品列表', 2, '/product', 5, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (
    17,
    '',
...
INSERT INTO `auth`
VALUES (19, '', '订单列表', 2, '/order', 6, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (20, '', '导航管理', 2, '/menu', 7, 0, '', 0, 0, 0);
INSERT INTO `auth`
VALUES (21, '', '商城设置', 2, '/setting', 7, 0, '', 0, 0, 0);
COMMIT;
-- ----------------------------
...
VALUES (
    ...
    'banner1',
    1,
    'static/upload/20201121/1605944396119681000.jpg',
    '/',
    1000,
    1,
    1603504343
...
VALUES (
    ...
    'banner2',
    1,
    'static/upload/20201024/1603504839411539000.jpg',
    '',
    1000,
    1,
    1603504839
...
INSERT INTO `menu`
VALUES (2, '手机', '', 1, 2, '1', 10, 1, 1603518198);
COMMIT;
-- ----------------------------
...
VALUES (
    ...
    'go web from ',
    1,
    'static/upload/20201023/1603440321653795000.png',
    66.66,
    1,
    '2',
    'red',
...
VALUES (
    ...
    '',
    '第一版',
    'static/upload/20201203/1607005318313835000.jpg',
    '',
    '',
    '1',
    '',
...
VALUES (
    ...
    4699.00,
    '23,24,39',
    ' 格式: 颜色:红色,白色,黄色 | 尺寸:41,42,43',
    '',
    'static/upload/20210118/1610940762322803000.jpg',
    '',
    '',
    '1',
    '',
...
VALUES (
    ...
    '',
    '',
    'static/upload/20210118/1610940776037983000.jpg',
    '',
    '',
    '1',
    '',
...
VALUES (12, 2, 1, 1, '平板电脑', 1, '', 10, 1610940762, 1);
COMMIT;
-- ----------------------------
...
VALUES (
    1,
    1,
    '/static/upload/20201024/1603519200684359000.jpg',
    0,
    10,
    1603519201,
    1
...
VALUES (
    2,
    1,
    '/static/upload/20201024/1603519285204437000.jpg',
    0,
    10,
    1603519291,
    1
...
VALUES (
    6,
    2,
    '/static/upload/20210118/1610940522542324000.jpg',
    0,
    10,
    1610940523,
    1
...
VALUES (
    7,
    2,
    '/static/upload/20210118/1610940522573123000.jpg',
    0,
    10,
    1610940523,
    1
...
VALUES (
    8,
    3,
    '/static/upload/20210118/1610940548355473000.jpg',
    0,
    10,
    1610940548,
    1
...
VALUES (1, 1, '平板电脑', 1, '', 1, 10, 1603440086);
COMMIT;
-- ----------------------------
...
BEGIN;
INSERT INTO `role`
VALUES (1, '超级管理员', '超级管理员', 1, 0);
INSERT INTO `role`
VALUES (2, '技术部', '技术部', 1, 1603518015);
INSERT INTO `role`
VALUES (3, '运营部', '运营部', 1, 1603518054);
COMMIT;
-- ----------------------------
...
VALUES (
    ...
    '20201102',
    1604288606,
    'e178c966721a75236355d935ac3dd9ff'
  );
INSERT INTO `user_sms`
VALUES (
    2,
    ...
    '20201119',
    1605759728,
    '200f0a43fbc9c0ae40f26432269cae91'
  );
INSERT INTO `user_sms`
VALUES (
    3,
    ...
    '20201119',
    1605759900,
    '5abc5dca4b31c1cfe222693ee1c5bd1c'
  );
COMMIT;
